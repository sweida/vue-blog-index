<template>
  <mu-container>
    <mu-alert color="info">
      ...
      视频分类：{{name}}（共{{guochan.length}}个视频）
    </mu-alert>
    ...
    <mu-flex justify-content="center" style="margin: 32px 0;">
      <mu-pagination raised :total="guochan.length" :page-size="pageSize" :page-count=5 :current.sync="current" @change="handlpage"></mu-pagination>
    </mu-flex>
  </mu-container>
</template>
