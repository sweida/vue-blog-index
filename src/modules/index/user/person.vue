...
export default {
  ...
  methods: {
    getComment() {
      this.$api.CommentPerson(this.pageModel1).then(res => {
        this.loading = false
    ...
    deleteComment(item) {
      ...
      this.$api.CommentDelete(param).then(res => {
    ...
    getMessage() {
      this.$api.MessagePerson(this.pageModel2).then(res => {
        this.loading = false
    ...
    deleteMessage(item) {
      ...
      this.$api.MessageDelete(param).then(res => {
